...
interface ERC721ApproveLockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721ApproveLock extends BaseContract {
  ...
  interface: ERC721ApproveLockInterface;
