...
interface ProjectFeeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setFees(address,uint256[],address[])": FunctionFragment;
...
export class ProjectFee extends BaseContract {
