...
interface ERC721ExampleInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721Example extends BaseContract {
  ...
  interface: ERC721ExampleInterface;
  ...
  callStatic: {
    ...
    mint(recipient: string, overrides?: CallOverrides): Promise<void>;
