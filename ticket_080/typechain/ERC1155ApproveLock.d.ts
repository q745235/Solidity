...
interface ERC1155ApproveLockInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155ApproveLock extends BaseContract {
  ...
  interface: ERC1155ApproveLockInterface;
  ...
  functions: {
    ...
    tokenName(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
