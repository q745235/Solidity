...
interface MultiPurchaseTimeInterface extends ethers.utils.Interface {
  functions: {
    ...
    "purchaseTimes(uint256)": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revokeManager(address)": FunctionFragment;
    "revokeMinter(address)": FunctionFragment;
    "revokeRole(bytes32,address)": FunctionFragment;
    "setPurchaseTime(uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "purchaseTimes",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class MultiPurchaseTime extends BaseContract {
  ...
  interface: MultiPurchaseTimeInterface;
